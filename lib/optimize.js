...
const JUNK_HEADING = /related (posts|articles|pages)|recent (posts|articles)|categories|archives|leave a (comment|reply)|share this|search|sidebar|newsletter|follow us|post navigation/i;
...
function extractPageSections(html) {
  ...
  const introText = htmlToBlockText(parts[0]);
  const sections = [];
